        ...
        public ActionResult Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    this.SetAlert("<strong><a href=\"http://www.youtube.com/watch?v=3K7GPKt9vIk&list=PLE67C6AEE86200F0C\" targe=\"_blank\">WELL VIVE LA FUCKING FRANCE, MAN!</a></strong> You just signed up.", AlertType.Success);
                    return RedirectToAction("Index", "Home");
                }
